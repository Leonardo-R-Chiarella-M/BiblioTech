...
<head>
    ...
    <title>Monitoreo Profesional - BiblioTech</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        .grid-mapa { display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 20px; }
        
        /* Tarjetas */
        .card-ocupada { background: #fff; border-left: 6px solid #e74c3c; border-radius: 15px; padding: 20px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border: 1px solid #f2f2f2; }
...
<body>
    <div class="container">
        <div class="header">
            <h1><i class="fas fa-desktop"></i> Monitoreo de Cubículos</h1>
        ...
        <div class="grid-mapa">
            ...
            $ocupados_map = [];
            foreach($prestamos as $p) { $ocupados_map[$p['numero_cubiculo']] = $p; }

            for($i = 1; $i <= $max_cubiculos; $i++): 
                if(isset($ocupados_map[$i])): 
                    $data = $ocupados_map[$i];
                    
                    // Cálculo de segundos totales hasta el fin
            ...
            ?>
                <div class="card-ocupada">
                    <div style="display:flex; justify-content:space-between; margin-bottom:12px; align-items:center;">
                        <span class="badge-num">CUBÍCULO #<?php echo $i; ?></span>
                    ...
                    <a href="../cubiculos/finalizar?id=<?php echo $data['id']; ?>" class="btn-liberar" onclick="return confirm('¿Liberar este espacio?')">FINALIZAR</a>
                </div>
            <?php else: ?>
                <div class="card-libre">
                    <span class="badge-num" style="background:#eee; color:#999; margin-bottom:12px;">N° <?php echo $i; ?></span>
                    <i class="fas fa-check-circle" style="font-size: 2.5rem; margin-bottom: 8px; color:#eee;"></i>
        ...
        <div class="header" style="margin-top: 50px; border-bottom: 2px solid #f1f2f6; padding-bottom: 10px;">
            ...
            <a href="../cubiculos/exportar" style="background:#27ae60; color:white; padding:8px 15px; border-radius:8px; text-decoration:none; font-size:0.8rem;"><i class="fas fa-file-excel"></i> Excel</a>
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            <td><strong>#<?php echo $h['numero_cubiculo']; ?></strong></td>
        ...
        function updateTimers() {
            ...
            timers.forEach(timer => {
                ...
                if (seconds < 0) {
                    ...
                    textElement.innerHTML = "-" + formatted; // Indica exceso con signo menos
                } else {
